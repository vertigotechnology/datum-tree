...
usage
 ...
 , " -store  <FILE>               Store result to a file."
 , " -group  <NAMES..>            Group by the given names."
 , " -gather <NAMES..>            Gather by the given names."
 , " -rename-fields    <NAMES..>  Rename tuple fields."
 , " -on     <NAMES..> <STAGE>    Perform an operation at the given path."
 ]
